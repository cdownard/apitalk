...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { author_id: @blog_post.author_id, body: @blog_post.body, published_at: @blog_post.published_at }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { author_id: @blog_post.author_id, body: @blog_post.body, published_at: @blog_post.published_at }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
